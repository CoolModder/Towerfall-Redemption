...
[CustomArrows("BaitArrow", "CreateGraphicPickup")]
public class BaitArrow : Arrow
{
    ...
    {
        var graphic = new Sprite<int>(ExampleModModule.BaitAtlas["BaitArrowPickup"], 12, 12, 0);
        graphic.Add(0, 0.3f, new int[2] { 0, 0 });
        graphic.Play(0, false);
        graphic.CenterOrigin();
        var arrowInfo = ArrowInfo.Create(graphic, ExampleModModule.BaitAtlas["BaitArrowHud"]);
    ...
    {
        normalImage = new Image(ExampleModModule.BaitAtlas["BaitArrow"]);
        normalImage.Origin = new Vector2(13f, 3f);
        buriedImage = new Image(ExampleModModule.BaitAtlas["BaitArrowBuried"]);
