...
[CustomArrows("PrismTrapArrow", "CreateGraphicPickup")]
public class PrismTrapArrow : Arrow
{
    ...
    {
        var graphic = new Sprite<int>(ExampleModModule.PrismTrapAtlas["PrismTrapArrowPickup"], 12, 12, 0);
        graphic.Add(0, 0.3f, new int[2] { 0, 0 });
        graphic.Play(0, false);
        graphic.CenterOrigin();
        var arrowInfo = ArrowInfo.Create(graphic, ExampleModModule.PrismTrapAtlas["PrismTrapArrowHud"]);
    ...
    {
        normalImage = new Image(ExampleModModule.PrismTrapAtlas["PrismTrapArrow"]);
        normalImage.Origin = new Vector2(13f, 3f);
        buriedImage = new Image(ExampleModModule.PrismTrapAtlas["PrismTrapArrowBuried"]);
