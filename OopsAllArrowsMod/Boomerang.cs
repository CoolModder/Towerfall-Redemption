...
[CustomArrows("BoomerangArrow", "CreateGraphicPickup")]
public class BoomerangArrow : Arrow
{
    ...
    {
        var graphic = new Sprite<int>(ExampleModModule.BoomerangAtlas["BoomerangArrowPickup"], 12, 12, 0);
        graphic.Add(0, 0.3f, new int[2] { 0, 0 });
        graphic.Play(0, false);
        graphic.CenterOrigin();
        var arrowInfo = ArrowInfo.Create(graphic, ExampleModModule.BoomerangAtlas["BoomerangArrowHud"]);
    ...
    {
        normalImage = new Sprite<int>(ExampleModModule.BoomerangAtlas["BoomerangArrow"],13,4);
        normalImage.Origin = new Vector2(13f, 3f);
        normalImage.Add(0, 0.1f, new int[2] { 0, 1 });
        normalImage.Play(0, false);
        buriedImage = new Sprite<int>(ExampleModModule.BoomerangAtlas["BoomerangArrowBuried"],13,4);
