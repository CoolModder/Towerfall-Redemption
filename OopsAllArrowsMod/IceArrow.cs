...
[CustomArrows("IceArrow", "CreateGraphicPickup")]
public class IceArrow : Arrow
{
    ...
    {
        var graphic = new Sprite<int>(ExampleModModule.IceAtlas["IceArrowPickup"], 12, 12, 0);
        graphic.Add(0, 0.3f, new int[2] { 0, 0 });
        graphic.Play(0, false);
        graphic.CenterOrigin();
        var arrowInfo = ArrowInfo.Create(graphic, ExampleModModule.IceAtlas["IceArrowHud"]);
    ...
    {
        normalImage = new Image(ExampleModModule.IceAtlas["IceArrow"]);
        normalImage.Origin = new Vector2(11f, 3f);
        buriedImage = new Image(ExampleModModule.IceAtlas["IceArrowBuried"]);
