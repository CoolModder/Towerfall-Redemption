...
[CustomArrows("FreakyArrow", "CreateGraphicPickup")]
public class FreakyArrow : Arrow
{
    ...
    {
        var graphic = new Sprite<int>(ExampleModModule.FreakyAtlas["FreakyArrowPickup"], 12, 12, 0);
        graphic.Add(0, 0.3f, new int[2] { 0, 1 });
        graphic.Play(0, false);
        graphic.CenterOrigin();
        var arrowInfo = ArrowInfo.Create(graphic, ExampleModModule.FreakyAtlas["FreakyArrowHud"]);
    ...
    {
        normalImage = new Image(ExampleModModule.FreakyAtlas["FreakyArrow"]);
        normalImage.Origin = new Vector2(13f, 3f);
        buriedImage = new Image(ExampleModModule.FreakyAtlas["FreakyArrowBuried"]);
