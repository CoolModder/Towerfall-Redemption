...
public class CrystalArrow : Arrow
{
    ...
    {
        var graphic = new Sprite<int>(ExampleModModule.CrystalAtlas["CrystalArrowPickup"], 12, 12, 0);
        graphic.Add(0, 0.3f, new int[2] { 0, 0 });
        graphic.Play(0, false);
        graphic.CenterOrigin();
        var arrowInfo = ArrowInfo.Create(graphic, ExampleModModule.CrystalAtlas["CrystalArrowHud"]);
    ...
    {
        normalImage = new Image(ExampleModModule.CrystalAtlas["CrystalArrow"]);
        normalImage.Origin = new Vector2(13f, 3f);
        buriedImage = new Image(ExampleModModule.CrystalAtlas["CrystalArrowBuried"]);
